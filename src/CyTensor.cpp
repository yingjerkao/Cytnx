...
namespace cytnx{
    ...
    template<> CyTensor& CyTensor::operator+=<CyTensor>(const CyTensor &rc){
        *this = cytnx::xlinalg::Add(*this,rc);
        return *this;
    }
    ...
    // -= 
    template<> CyTensor& CyTensor::operator-=<CyTensor>(const CyTensor &rc){
        *this = cytnx::xlinalg::Sub(*this,rc);
        return *this;
    }
    template<> CyTensor& CyTensor::operator-=<cytnx_complex128>(const cytnx_complex128 &rc){
        *this = cytnx::xlinalg::Sub(*this,rc);
    ...
    // *= 
    template<> CyTensor& CyTensor::operator*=<CyTensor>(const CyTensor &rc){
        *this = cytnx::xlinalg::Mul(*this,rc);
        return *this;
    }
    template<> CyTensor& CyTensor::operator*=<cytnx_complex128>(const cytnx_complex128 &rc){
        *this = cytnx::xlinalg::Mul(*this,rc);
    ...
    // /=
    template<> CyTensor& CyTensor::operator/=<CyTensor>(const CyTensor &rc){
        *this = cytnx::xlinalg::Div(*this,rc);
        return *this;
    }
    template<> CyTensor& CyTensor::operator/=<cytnx_complex128>(const cytnx_complex128 &rc){
        *this = cytnx::xlinalg::Div(*this,rc);
    ...
    CyTensor CyTensor::Pow(const double &p) const{
        return cytnx::xlinalg::Pow(*this,p);
    }
    CyTensor& CyTensor::Pow_(const double &p){
        cytnx::xlinalg::Pow_(*this,p);
        return *this;
    }
